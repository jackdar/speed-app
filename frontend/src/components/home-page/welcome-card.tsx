...
export default function HomeWelcomeCard() {
  ...
  return (
    <div className="flex justify-center items-center bg-[#8D8D8D] p-8">
      <div className="bg-gray-100 p-8 rounded shadow-md w-2/3">
        ...
        <p className="mb-4">
          ...
          articles shared by our community, or search for articles on a specific topic on the article search page. Alternatively, if you
          would like to submit a new article for review, sign in or sign up for free to submit.
        </p>
